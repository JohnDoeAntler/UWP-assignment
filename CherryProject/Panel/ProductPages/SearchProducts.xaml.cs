...
namespace CherryProject.Panel.ProductPages
{
    ...
    public sealed partial class SearchProducts : Page
	{
		...
		private readonly ObservableCollection<Model.Product> _searchProductGridViewItems;
		private readonly Dictionary<string, Predicate<Model.Product>> keyValuePairs;
		private Type searchStatus;

		public ObservableCollection<string> SearchFilters => _searchFilters;
		public ObservableCollection<Model.Product> SearchProductGridViewItems => _searchProductGridViewItems;
